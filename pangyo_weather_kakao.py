...
- 빈 줄 후 "👗 나나의 옷장" 섹션: ▸ 로 시작하는 1줄 (위 옷차림 후보에서 1~2개만 골라 추천. 매번 다른 표현을 써야 함. "~조합이면 딱" 패턴 반복 금지. 날씨 상황에 맞게 구체적으로. 예: "바람 부니까 바람막이 안에 니트!", "낮엔 가디건만으로 충분해요", "아침엔 코트 필수, 낮엔 벗어도 돼요")
